...
public class SquareFactory {
	...
	public Square createMiddleSquare(int index)
	{
		...
		{
		case 0:
			return new GoSquare(squareNames_inner[index], "GoSquare");
		case 1:
			return new PropertySquare(squareNames_inner[index], "Property", MediterranianPrice, MediterranianColor, MediterranianAveList);
		case 2:
			return new CommunityChestCardSquare(squareNames_inner[index], "CommunityChestCardSquare");
		case 3:
			return new PropertySquare(squareNames_inner[index], "Property", BalticPrice, BalticColor, BalticAveList);
		case 4:
			return new IncomeTaxSquare(squareNames_inner[index], "IncomeTaxSquare");
		case 5:
			return new RailRoadTransitStationsSquare(squareNames_inner[index], "RailroadTransitSquare");
		case 6:
			return new PropertySquare(squareNames_inner[index], "Property", OrientalPrice, OrientalColor, OrientalAveList);
		case 7:
			return new ChanceCardSquare(squareNames_inner[index], "ChanceCardSquare");
		case 8:
			return new PropertySquare(squareNames_inner[index], "Property", VermontPrice, VermontColor, VermontAveList);
		case 9:
			return new PropertySquare(squareNames_inner[index], "Property", ConnecticutPrice, ConnecticutColor, MediterranianAveList);
		case 10:
			return new EmptySquare(squareNames_inner[index], "JailSquare");
		case 11:
			return new PropertySquare(squareNames_inner[index], "Property", StCharlesPrice, StCharlesColor, StCharlesList);
		case 12:
			return new UtilitySquare(squareNames_inner[index], "Utility");
		case 13:
			return new PropertySquare(squareNames_inner[index], "Property", StatesPrice, StatesColor, StatesAveList);
		case 14:
			return new PropertySquare(squareNames_inner[index], "Property", VirginiaPrice, VirginiaColor, VirginiaAveList);
		default:
			return null;
		}
	}
